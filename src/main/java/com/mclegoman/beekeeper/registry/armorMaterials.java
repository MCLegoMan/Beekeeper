...
public enum armorMaterials implements ArmorMaterial {
    GOLD_CHAIN("gold_chain", 5, new int[]{1, 3, 5, 2}, 22, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(Items.GOLD_INGOT);
    }),
    DIAMOND_CHAIN("diamond_chain", 31, new int[]{3, 6, 8, 3}, 7, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5F, 0.0F, () -> {
        return Ingredient.ofItems(Items.DIAMOND);
    }),
    NETHERITE_CHAIN("netherite_chain", 35, new int[]{3, 6, 8, 3}, 12, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2.5F, 0.05F, () -> {
